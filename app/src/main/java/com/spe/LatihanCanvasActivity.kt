...
import com.spe.databinding.ActivityLatihanCanvasBinding

class LatihanCanvasActivity : AppCompatActivity() {


    private lateinit var binding: ActivityLatihanCanvasBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityLatihanCanvasBinding.inflate(layoutInflater)
